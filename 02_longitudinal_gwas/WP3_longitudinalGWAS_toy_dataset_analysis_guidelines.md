...
--nofilter \
--thread-num 4 \
--out Toy_bmi_adults_dummy_fit_gcta

gcta64 \
--bfile Toy_bmi_adults_2 \
--nofilter \
--load-model Toy_bmi_adults_dummy_fit_gcta.fastGWA \
--out Toy_bmi_adults_dummy_fit_gcta_out \
--thread-num 4
...
--nofilter \
--thread-num 4 \
--out Toy_bmi_elderly_dummy_fit_gcta

gcta64 \
--bfile Toy_bmi_elderly_2 \
--nofilter \
--load-model Toy_bmi_elderly_dummy_fit_gcta.fastGWA \
--out Toy_bmi_elderly_dummy_fit_gcta_out \
--thread-num 4
...
--nofilter \
--thread-num 4 \
--out Toy_weight_adults_dummy_fit_gcta

gcta64 \
--bfile Toy_weight_adults_2 \
--nofilter \
--load-model Toy_weight_adults_dummy_fit_gcta.fastGWA \
--out Toy_weight_adults_dummy_fit_gcta_out \
--thread-num 4
...
--nofilter \
--thread-num 4 \
--out Toy_weight_elderly_dummy_fit_gcta

gcta64 \
--bfile Toy_weight_elderly_2 \
--nofilter \
--load-model Toy_weight_elderly_dummy_fit_gcta.fastGWA \
--out Toy_weight_elderly_dummy_fit_gcta_out \
--thread-num 4
```
...
Toy_bmi_adults_SNP_info   <- data.table::fread(paste0(main_path, "Output//", "Toy_bmi_adults_dummy_fit_gcta_out.fastGWA"), header = TRUE)
Toy_bmi_adults_SNP_info   <- as.data.frame(Toy_bmi_adults_SNP_info)
Toy_bmi_adults_SNP_info   <- Toy_bmi_adults_SNP_info[c("CHR", "SNP", "POS", "A1", "A2", "N", "AF1")]

Toy_bmi_elderly_SNP_info <- data.table::fread(paste0(main_path, "Output//", "Toy_bmi_elderly_dummy_fit_gcta_out.fastGWA"), header = TRUE)
Toy_bmi_elderly_SNP_info <- as.data.frame(Toy_bmi_elderly_SNP_info)
Toy_bmi_elderly_SNP_info <- Toy_bmi_elderly_SNP_info[c("CHR", "SNP", "POS", "A1", "A2", "N", "AF1")]

Toy_weight_adults_SNP_info   <- data.table::fread(paste0(main_path, "Output//", "Toy_weight_adults_dummy_fit_gcta_out.fastGWA"), header = TRUE)
Toy_weight_adults_SNP_info   <- as.data.frame(Toy_weight_adults_SNP_info)
Toy_weight_adults_SNP_info   <- Toy_weight_adults_SNP_info[c("CHR", "SNP", "POS", "A1", "A2", "N", "AF1")]

Toy_weight_elderly_SNP_info  <- data.table::fread(paste0(main_path, "Output//", "Toy_weight_elderly_dummy_fit_gcta_out.fastGWA"), header = TRUE)
Toy_weight_elderly_SNP_info  <- as.data.frame(Toy_weight_elderly_SNP_info)
Toy_weight_elderly_SNP_info  <- Toy_weight_elderly_SNP_info[c("CHR", "SNP", "POS", "A1", "A2", "N", "AF1")]
...
sumstats_BMI_adulthood    <- sumstats_BMI_adulthood[BMI_keep_cols]
sumstats_BMI_elderly      <- sumstats_BMI_elderly[BMI_keep_cols]
...
ncol(genotype_matrix_BMI_adulthood) == nrow(Toy_weight_elderly_SNP_info)

###########################################################################
#
# Modeling - estimation of SNP effect sizes
#
###########################################################################
...
modeling_BMI_adulthood    <- modeling_fun(pheno_data = sumstats_BMI_adulthood,
                                          ...
                                          SNP_IDs    = SNP_IDs,
                                          SNP_info   = Toy_bmi_adults_SNP_info,
                                          pheno      = "BMI"
                                          )
...
modeling_BMI_elderly      <- modeling_fun(pheno_data = sumstats_BMI_elderly,
                                          ...
                                          SNP_IDs    = SNP_IDs,
                                          SNP_info   = Toy_bmi_elderly_SNP_info,
                                          pheno      = "BMI")
...
modeling_weight_adulthood <- modeling_fun(pheno_data = sumstats_weight_adulthood,
                                          ...
                                          SNP_IDs    = SNP_IDs,
                                          SNP_info   = Toy_weight_adults_SNP_info,
                                          pheno      = "Weight")
...
modeling_weight_elderly   <- modeling_fun(pheno_data = sumstats_weight_elderly,
                                          ...
                                          SNP_IDs    = SNP_IDs,
                                          SNP_info   = Toy_weight_elderly_SNP_info,
                                          pheno      = "Weight")
...
The summary statistics are in `..._modeling_...txt`.

The estimated ratio of the sampling noise to individual environmental noise is in `..._varratio_...txt`.

**Step 3: Compress effect size estimates statistics files and upload**
  
```
zip -r Toy_bmi_modeling_adults.zip Toy_bmi_modeling_adults.txt
zip -r Toy_bmi_modeling_elderly.zip Toy_bmi_modeling_elderly.txt

zip -r Toy_weight_modeling_adults.zip Toy_weight_modeling_adults.txt
zip -r Toy_weight_modeling_elderly.zip Toy_weight_modeling_elderly.txt
```
